...
I took bootstrap samples from 133 countries in `df_sub` with replacement. This wa case resampling, so the information from each country remained together. Here I had to drop the `log(confirmed_rate)` term in the formula to make the `glm` results converge.
