...
To assess the model, I need to check whether the "LINE" conditions for multiple linear regression hold for this model. The data were collected in each country independently, so I would assume that the independence assumption is reasonable.
...
```
 ...
 Then, let's look at the rest assumptions:
